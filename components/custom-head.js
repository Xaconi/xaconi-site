...
export default function CustomHead({ title, description, image, link, type}) {
    ...
    return(
        <Head>
            ...
            {/* FACEBOOK */}
            <meta property="og:url" content={ getBaseURL(link) } />
            <meta property="og:title" content={ title } />
            <meta property="og:description" content={ description } />
            <meta property="og:image" content={ getBaseURL(image) } />
            <meta property="og:image:secure_url" content={ getBaseURL(image) } />
            ...
            <meta name="twitter:domain" content={ getBaseURL('') } />
            <meta name="twitter:image:src" content={ getBaseURL(image) } />
